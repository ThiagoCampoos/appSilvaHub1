...
**Subtarefas:**
- [ ] Criar arquivo `Color.kt` em `ui/theme/`
- [ ] Definir cores primárias (verde para saldo positivo)
- [ ] Definir cores secundárias (vermelho para saldo negativo/gastos)
- [ ] Definir cores neutras (cinza para fundo, preto/branco para texto)
- [ ] Definir cores de status (sucesso, erro, aviso, info)
...
**Dependências:** Task 1.2 (estrutura de pacotes)  
**Critério de Aceitação:**
- [ ] `Color.kt` criado com todas as cores
...
**Subtarefas:**
- [ ] Criar arquivo `Theme.kt` em `ui/theme/`
- [ ] Implementar `LightColorScheme()` com cores do `Color.kt`
- [ ] Implementar `DarkColorScheme()` com variações para modo escuro
- [ ] Criar composable `SilvaHubTheme()` que aplica o tema
- [ ] Adicionar suporte a modo claro/escuro automático
- [ ] Integrar com `Type.kt` (tipografia - criar depois)
...
**Critério de Aceitação:**
- [ ] `Theme.kt` criado e compilando
- [ ] Suporta Light e Dark mode
- [ ] Aplicável via `SilvaHubTheme { }`
...
**Subtarefas:**
- [ ] Criar arquivo `Type.kt` em `ui/theme/`
- [ ] Definir `displayLarge`, `displayMedium`, `displaySmall` para títulos grandes
- [ ] Definir `headlineLarge`, `headlineMedium`, `headlineSmall` para headings
- [ ] Definir `titleLarge`, `titleMedium`, `titleSmall` para títulos de seções
- [ ] Definir `bodyLarge`, `bodyMedium`, `bodySmall` para corpo de texto
- [ ] Definir `labelLarge`, `labelMedium`, `labelSmall` para labels
...
**Dependências:** Task 1.2 (estrutura de pacotes)  
**Critério de Aceitação:**
- [ ] `Type.kt` criado com tipografia completa
- [ ] Compilando sem erros
- [ ] Referenciado em `Theme.kt`
...
**Subtarefas:**
- [ ] Criar arquivo `App.kt` em `com/example/silvahub/`
- [ ] Criar composable `App()` que encapsula o tema
- [ ] Configurar navegação básica (placeholder para NavHost)
- [ ] Envolver com `SilvaHubTheme`
- [ ] Adicionar Surface como background
...
**Critério de Aceitação:**
- [ ] `App.kt` criado e compilando
- [ ] Encapsula o tema corretamente
- [ ] Pronto para integração de navegação
...
**Subtarefas:**
- [ ] Abrir `MainActivity.kt` em `androidMain/`
- [ ] Manter classe que estende `ComponentActivity`
- [ ] No `onCreate()`, usar `setContent { App() }`
- [ ] Remover qualquer composable antigo de placeholder
- [ ] Testar compilação
...
**Subtarefas:**
- [ ] Criar arquivo `KoinModule.kt` em `di/`
- [ ] Definir módulo `appModule`
- [ ] Registrar `AppDatabase` como singleton
- [ ] Registrar DAOs como singletons (vazios por enquanto)
- [ ] Criar `App.kt` em `androidMain/` (Application class) para inicializar Koin
- [ ] Adicionar `android:name` em `AndroidManifest.xml` apontando para a classe Application
...
**Critério de Aceitação:**
- [ ] `KoinModule.kt` criado com módulo completo
- [ ] `SilvaHubApp` classe criada e compilando
...
**Subtarefas:**
- [ ] Criar pasta `docs/phases/` se não existir
- [ ] Criar arquivo `FASE_1_Setup.md`
- [ ] Documentar objetivos completados
- [ ] Explicar decisões arquiteturais (por que Koin, por que Clean Architecture)
- [ ] Listar dependências adicionadas e versões
- [ ] Criar seção de próximos passos (Fase 2)
- [ ] Adicionar diagrama de estrutura de pacotes (ASCII ou referência)
...
**Critério de Aceitação:**
- [ ] `FASE_1_Setup.md` criado em `docs/phases/`
- [ ] Documentação clara e completa
- [ ] Referencia todas as decisões técnicas
...
**Subtarefas:**
- [ ] Executar `./gradlew clean` para limpar builds anteriores
- [ ] Executar `./gradlew build` para compilar o projeto completo
- [ ] Verificar ausência de erros e warnings críticos
- [ ] Testar no emulador/dispositivo (build debug)
- [ ] Verificar se o app abre sem crashes
...
**Subtarefas:**
- [ ] Verificar existência de `.gitignore`
- [ ] Adicionar padrões para arquivos gerados (build/, .gradle/)
- [ ] Adicionar padrões para IDE (.idea/, *.iml)
- [ ] Garantir que `local.properties` está ignorado

**Estimativa:** 10 minutos  
**Dependências:** Nenhuma crítica  
**Critério de Aceitação:**
- [ ] `.gitignore` contém padrões corretos
- [ ] Arquivos gerados não aparecem em `git status`
...
- [ ] Task 1.1: libs.versions.toml atualizado
- [ ] Task 1.2: Estrutura de pacotes criada
- [ ] Task 1.3: AppDatabase configurado
- [ ] Task 1.4: Color.kt personalizado
- [ ] Task 1.5: Theme.kt customizado
- [ ] Task 1.6: Type.kt implementado
- [ ] Task 1.7: App.kt criado
- [ ] Task 1.8: MainActivity.kt atualizado
- [ ] Task 1.9: Koin configurado
- [ ] Task 1.10: Documentação FASE_1.md
- [ ] Task 1.11: Teste de compilação OK
- [ ] Task 1.12: .gitignore atualizado
